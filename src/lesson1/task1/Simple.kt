 ...
 */
fun seconds(hours: Int, minutes: Int, seconds: Int): Int = (minutes + hours * 60) * 60 + seconds
 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = (((deg * 60 + min) * 60 + sec) * PI / (180 * 60 * 60))
 ...
 */
// 48 - код нуля в Unicode
fun thirdDigit(number: Int): Int = number.toString()[number.toString().length - 3].toInt() - 48
